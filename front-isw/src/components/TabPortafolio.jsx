// src/components/TabPortafolio.jsx
...
export default function TabPortafolio({ usuario: usuarioProp }) {
  ...
  const esEstudiante = rolNormalizado === "ESTUDIANTE";
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setMensaje({ tipo: "warn", texto: `No se pudo contactar la API (${err.message}). Guardado localmente.` });
      setModalAbierto(false);
    } finally {
      setLoading(false);
    }
